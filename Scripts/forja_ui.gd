...
func _build_close_button() -> void:
	...
	close_button.text = "×"
	close_button.position = Vector2(1493, 133)
...
func _open_item_selector(slot_index: int) -> void:
	...
	selector_panel.position = Vector2(656, 270)
	selector_panel.size = Vector2(860, 440)
	...
	scroll.position = Vector2(112, 110)
	scroll.size = Vector2(808, 320)
