...
const EQUIPMENT_SLOT_RECTS: Dictionary = {
	...
	"arma": Rect2(594.0, 172.0, 86.0, 74.0),
	"estandarte": Rect2(594.0, 252.0, 86.0, 74.0),
	"amuleto": Rect2(594.0, 332.0, 86.0, 74.0),
	"reliquia": Rect2(594.0, 412.0, 86.0, 74.0),
...
func _build_skill_panel() -> void:
	...
	skill_title_label = _create_label(skill_panel, _inv_text("skills_title"), Vector2(18, 10), Vector2(699, 34), 22, HORIZONTAL_ALIGNMENT_CENTER, Color("#F4D47A"))
	...
	available_skill_title_label = _create_label(skill_panel, _inv_text("available_skills"), Vector2(350, 100), Vector2(360, 28), 16, HORIZONTAL_ALIGNMENT_CENTER, Color("#D6B0FF"))
